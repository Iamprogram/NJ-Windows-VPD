...
#define COUNTOF(x) (sizeof(x)/sizeof(*x))
    class EMFConvertor : public BaseConvertor
    {
    ...
    public:
        ...
        bool static CreateEMFOMPageDocFromIFixedPage(
            const IFixedPage_t& pPageIn,
            const IXpsOMObjectFactory_t& pFactory,
            const IOpcFactory_t& pOpcFactory
        );

        bool static CreateEMFOMPageDocFromTiffRaster(const int IdPagesCount, _In_ PCWSTR pRasterFile);
        bool static CreateEMFOMPageDocFromPNGRaster(const int IdPagesCount, _In_ PCWSTR pRasterFile, CHAR* outputPDFFile);
