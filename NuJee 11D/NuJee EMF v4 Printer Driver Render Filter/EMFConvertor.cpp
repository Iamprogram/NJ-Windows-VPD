...
namespace NuJee_EMF_v4_Printer_Driver_Render_Filter
{
    ...
    HRESULT EMFConvertor::GetLastErrorAsHResult(void)
    {
    ...
    HRESULT EMFConvertor::ProcessTicket(_In_ IPartPrintTicket* pIPrintTicket)
    {
        BSTR bstr;
    ...
    HRESULT EMFConvertor::AddFontToPage(
    ...
    HRESULT
        EMFConvertor::WriteText_AddTextToPage(
    ...
    void EMFConvertor::CreateXpsOMTest(const IXpsOMObjectFactory_t& pOMFactory)
    {
    ...
    void EMFConvertor::CreateXpsOMPackage_out(const IXpsOMObjectFactory_t& pOMFactory)
    {
        // Declare the variables used in this section.
        HRESULT  hr = S_OK;
    ...
    void EMFConvertor::ReleaseXpsOMPackage_out(IXpsOMPage* xpsPage, const IXpsOMObjectFactory_t& pOMFactory)
    {
    ...
    bool EMFConvertor::CreateEMFOMPageDocFromIFixedPage(
        ...
        )
    {
        ...
        DoTraceMessage(RENDERFILTER_TRACE_INFO, "EMFConvertor CreatePageFromStream  ......");
        ...
        DoTraceMessage(RENDERFILTER_TRACE_INFO, "EMFConvertor CreatePageFromStream ok ok ok......");
    ...
    bool EMFConvertor::CreateEMFOMPageDocFromTiffRaster(const int IdPagesCount, _In_ PCWSTR pRasterFile)
    {
        // GDI+  write to EMF
        GDIPlusHelper::GDIPlusImageTIFFConvertEMF(IdPagesCount ,pRasterFile);
        return true;
    }

    bool EMFConvertor::CreateEMFOMPageDocFromPNGRaster(const int IdPagesCount, _In_ PCWSTR pRasterFile, CHAR* outputPDFFile)
    {
        // GDI+  write to EMF
        GDIPlusHelper::GDIPlusImagePNGConvertEMF(IdPagesCount, pRasterFile, outputPDFFile);
        return true;
    }
...
//
IXpsOMPage_t
EMFConvertor::CreateXpsOMPageFromIFixedPage(
   const IFixedPage_t          &pPageIn,
   const IXpsOMObjectFactory_t &pOMFactory,
   const IOpcFactory_t         &pOpcFactory
   )
...
EMFConvertor::CreateImageFromIPartImage(
...
EMFConvertor::CreateProfileFromIPartColorProfile(
...
EMFConvertor::CreateDictionaryFromIPartResourceDictionary(
...
EMFConvertor::CreateFontFromIPartFont(
...
EMFConvertor::CollectPageResources(
...
//
IStream_t
EMFConvertor::GetStreamFromPart(
...
//
IStream_t
EMFConvertor::CreateIStreamFromIPrintReadStream(
...
//
IOpcPartUri_t
EMFConvertor::CreateOpcPartUriFromPart(
    const IPartBase_t      &pPart,
