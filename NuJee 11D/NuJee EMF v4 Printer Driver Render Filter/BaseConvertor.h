...
#define COUNTOF(x) (sizeof(x)/sizeof(*x))
    static IXpsOMPackage* xpsPackage_out;
    static IOpcPartUri* opcPartUri_out;
    static IXpsOMDocumentSequence* xpsFDS_out;
    static IXpsOMDocumentCollection* fixedDocuments_out;
    static IXpsOMDocument* xpsFD_out;
    ...
    public:
        ...
        static HRESULT   GetLastErrorAsHResult(void);
        static HRESULT  ProcessTicket(_In_ IPartPrintTicket* pIPrintTicket);
        static HRESULT  AddFontToPage(
            _In_    IPartFont* pNewFont,
            _In_    IPrintWriteStream* pFontStream,
            _In_    IFixedPage* pNewPage
        );
        static HRESULT  AddTextToPage(
        ...
        static void CreateXpsOMTest(
            const IXpsOMObjectFactory_t& pOMFactory
        );

        static void  ReleaseXpsOMPackage_out(IXpsOMPage* xpsPage, const IXpsOMObjectFactory_t& pOMFactory);
        static void  CreateXpsOMPackage_out(const IXpsOMObjectFactory_t& pOMFactory);
        static bool  CreateXpsOMPageDocFromIFixedPage(
