...
namespace NuJee_EMF_v4_Printer_Driver_Render_Filter
{
    ...
    HRESULT OMConvertor::GetLastErrorAsHResult(void)
    {
    ...
    HRESULT OMConvertor::ProcessTicket(_In_ IPartPrintTicket* pIPrintTicket)
    {
        BSTR bstr;
    ...
    HRESULT OMConvertor::AddFontToPage(
    ...
    HRESULT
        OMConvertor::WriteText_AddTextToPage(
    ...
    void OMConvertor::CreateXpsOMTest(const IXpsOMObjectFactory_t& pOMFactory)
    {
    ...
    void OMConvertor::CreateXpsOMPackage_out(const IXpsOMObjectFactory_t& pOMFactory)
    {
        // Declare the variables used in this section.
        HRESULT  hr = S_OK;
    ...
    void OMConvertor::ReleaseXpsOMPackage_out(IXpsOMPage* xpsPage, const IXpsOMObjectFactory_t& pOMFactory)
    {
    ...
    bool OMConvertor::CreateXpsOMPageDocFromIFixedPage(
        ...
        )
    {
        ...
        BSTR bstrUri;
        pPartUri->GetDisplayUri(&bstrUri);
        DoTraceMessage(RENDERFILTER_TRACE_INFO, "******************** pPartUri->GetDisplayUri uri %ws", static_cast<PCWSTR>(bstrUri));
        DoTraceMessage(RENDERFILTER_TRACE_INFO, "********************GetSourceUri pPartUri->GetDisplayUri uri %ws", static_cast<PCWSTR>(bstrUri));
        pPartUri->GetAbsoluteUri(&bstrUri);
        DoTraceMessage(RENDERFILTER_TRACE_INFO, "****************** pPartUri->GetAbsoluteUri......%ws", static_cast<PCWSTR>(bstrUri));
        BSTR bstrUser;
        pPartUri->GetUserNameW(&bstrUser);
        DoTraceMessage(RENDERFILTER_TRACE_INFO, "****************** pPartUri->GetUserNameW......%ws", static_cast<PCWSTR>(bstrUser));
...
//
IXpsOMPage_t
OMConvertor::CreateXpsOMPageFromIFixedPage(
   const IFixedPage_t          &pPageIn,
   const IXpsOMObjectFactory_t &pOMFactory,
   const IOpcFactory_t         &pOpcFactory
   )
...
OMConvertor::CreateImageFromIPartImage(
...
OMConvertor::CreateProfileFromIPartColorProfile(
...
OMConvertor::CreateDictionaryFromIPartResourceDictionary(
...
OMConvertor::CreateFontFromIPartFont(
...
OMConvertor::CollectPageResources(
...
//
IStream_t
OMConvertor::CreateIStreamFromIPrintReadStream(
...
//
IOpcPartUri_t
OMConvertor::CreateOpcPartUriFromPart(
    const IPartBase_t      &pPart,
