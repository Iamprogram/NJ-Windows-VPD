...
//
class __declspec(uuid("5b95db99-3649-464b-923c-5b86253525d4")) RenderFilterFactory : public UnknownBase<IClassFactory>
{
public:
    RenderFilterFactory() :
        m_serverLocks(0)
        ...
        )
    {
        ...
        *ppvObject = NULL;
        ...
        NuJee_EMF_v4_Printer_Driver_Render_Filter::RenderFilter *pFilter = NULL;
        ...
        try
        {
            ...
            pFilter = new NuJee_EMF_v4_Printer_Driver_Render_Filter::RenderFilter();
        }
        CATCH_VARIOUS(hr)
    ...
    )
{
    ...
    *ppv = NULL;
    ...
    if (rclsid != __uuidof(NuJee_EMF_v4_Printer_Driver_Render_Filter::RenderFilterFactory))
    {
    ...
    NuJee_EMF_v4_Printer_Driver_Render_Filter::RenderFilterFactory *pFactory = NULL;
    pFactory = new(std::nothrow) NuJee_EMF_v4_Printer_Driver_Render_Filter::RenderFilterFactory();
...
DllCanUnloadNow()
{
    return (0 == NuJee_EMF_v4_Printer_Driver_Render_Filter::RenderFilter::ms_numObjects) ? S_OK : S_FALSE;
}
    ...
    )
{
    ...
    case DLL_PROCESS_ATTACH:
        ...
        WPP_INIT_TRACING(L"NuJeeEMFv4PrinterDriverRenderFilter");
